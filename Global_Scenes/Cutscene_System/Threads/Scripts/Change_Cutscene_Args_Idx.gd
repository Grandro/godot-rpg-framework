...
func _process_command():
	...
	match type:
		"Set": interactions_comp.set_interaction_cutscene_args_idx(idx, value)
		"Increase": interactions_comp.increase_interaction_cutscene_args_idx(idx, value)
		"Decrease": interactions_comp.decrease_interaction_cutscene_args_idx(idx, value)
